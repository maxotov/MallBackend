<html>
<head><title>Mall Project Users</title>
...
if (count($users) > 0) {
    ...
    <div class="greetblock">
        <div class="leftdiv">
            ...
            <div class="usersdiv" style="overflow-y:scroll;">
            <table>
                ...
                while ($user = $users->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td><span class="wrapper"><input type="checkbox" name="sendmsg[]" value="<?php echo $user["id"] ?>"/></span></td>
                    </tr>
                <?php } ?>
            </table>
                </div>
        ...
        <div class="rightdiv">
            ...
            <select id="festival">
                <option value="http://itdamu.kz/MallBackend/images/gcm/ramzan.png">Ramadan</option>
                <option value="http://itdamu.kz/MallBackend/images/gcm/diwali.png">Other</option>
            </select>
            <br/>
            <img src="http://itdamu.kz/MallBackend/images/gcm/ramzan.png"/>
        </div>
        <div class="leftdiv">
